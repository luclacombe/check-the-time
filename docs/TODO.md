...
_Nothing in progress. v0.4.0 shipped. Next version to be scoped — see `docs/MAP.md`._

---

## Backlog

_No tasks in backlog. Next version (v0.5.0) to be scoped separately — see `docs/MAP.md`._
